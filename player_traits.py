...
SKATER_TRAITS = [
    Trait(
        ...
        category="physical",
        requirements=[("checking", 38), ("strength", 36), ("aggressiveness", 34)],
        sim_effects={
    ...
    Trait(
        ...
        category="skating",
        requirements=[("speed", 40), ("acceleration", 36)],
        sim_effects={
    ...
    Trait(
        ...
        category="offense",
        requirements=[("shooting", 40), ("shooting_accuracy", 38)],
        sim_effects={
    ...
    Trait(
        ...
        category="offense",
        requirements=[("passing", 40), ("passing_creativity", 36)],
        sim_effects={
    ...
    Trait(
        ...
        category="offense",
        requirements=[("deking", 40), ("agility", 36)],
        sim_effects={
    ...
    Trait(
        ...
        category="physical",
        requirements=[("forechecking", 38), ("determination", 36), ("balance", 34)],
        sim_effects={
    ...
    Trait(
        ...
        category="defense",
        requirements=[("defensive_awareness", 40), ("pokecheck", 36)],
        sim_effects={
    ...
    Trait(
        ...
        category="defense",
        requirements=[("defensive_awareness", 38), ("offensive_awareness", 36)],
        sim_effects={
    ...
    Trait(
        ...
        category="physical",
        requirements=[("strength", 38), ("aggressiveness", 38)],
        sim_effects={
            "fight_win_mult": 1.15,
    ...
    Trait(
        ...
        category="mental",
        requirements=[("pressure_player", 38), ("composure", 36)],
        sim_effects={
            "overtime_mult": 1.08,
            "shootout_mult": 1.10,
    ...
    Trait(
        ...
        category="offense",
        requirements=[("one_timer", 38), ("shooting_power", 36)],
        sim_effects={
            "one_timer_mult": 1.12,
